...
<template>
  ...
  <div class="flex w-1/4 flex-wrap mx-auto justify-center">
    <div class="flex flex-col w-full text-xl">
      ...
      <el-input v-model="loginData.username" class="w-full border-b-gray-600 border-b pb-1" placeholder="请输入账户名" />
    </div>
    <div class="flex flex-col w-full text-xl">
      <label class="my-4 font-bold text-xl"> 密码 </label>
      <el-input v-model="loginData.password" show-password class="w-full border-b-gray-600 border-b pb-1"
        placeholder="请输入密码" />
    </div>
