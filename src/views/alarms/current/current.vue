  ...
  <div style="display: flex; width: 100%">
    ...
    <div style="margin-left: 20px">
      ...
      <el-table
        ...
        :data="tableData"
        border
        style="margin-left: 0px; margin-top: 20px; width: 660px; height: auto"
          ...
          <template #default="scope">
            <el-popover placement="right" :width="400" trigger="click" ref="popover">
              <el-table :data="[scope.row]">
                <!-- 只显示当前行的数据 -->
                <el-table-column width="150" property="mingcheng" label="网络摄像头名称" />
                <el-table-column width="150" property="dizhi" label="RTSP地址" />
                <el-table-column width="100" property="shijian" label="修改时间" />
              </el-table>
              <template #reference>
