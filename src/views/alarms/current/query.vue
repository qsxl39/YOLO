                        ...
                        <template v-if="val.type !== ''">
                            <el-form-item :label="val.label" :prop="val.prop"
                                ...
                                <el-date-picker v-model="state.form[val.prop]" type="date"
                                    :placeholder="val.placeholder" v-else-if="val.type === 'date'" style="width: 100%"
                                ...
                                <el-input type="textarea" v-model="state.form[val.prop]" :placeholder="val.placeholder"
                                    clearable v-if="val.type === 'textarea'" style="width: 100%"
                            ...
                            <el-row :gutter="35" v-for="(v, k) in state.form.list" :key="k">
                                ...
                                <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="6" class="mb20">
                                    <el-form-item label="日度" :prop="`list[${k}].day`"
                                        ...
                                        <el-input v-model="state.form.list[k].day" style="width: 100%"
                                            placeholder="请输入"> </el-input>
                                    </el-form-item>
                                </el-col>
                            </el-row>
